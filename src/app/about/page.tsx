    ...
    <div className="relative min-h-screen bg-[#e6e7e8] font-sans selection:bg-[#c81c6a] selection:text-white pb-32">
      ...
      <section className="relative w-full max-w-[1700px] mx-auto px-6 md:px-12 h-[70vh] min-h-[500px] flex items-center justify-center my-10 z-30">
        ...
        <div className="absolute left-6 md:left-[10%] top-[30%] flex flex-col gap-1 items-start z-30">
          <span className="text-xl md:text-3xl font-bold font-brand-heading text-[#b3b4b6] leading-none whitespace-pre-line">{get('about.section_1_5_label_jam', 'Dragon\nFruit Jam')}</span>
        </div>
        <div className="absolute left-6 md:left-[10%] bottom-[20%] flex flex-col gap-1 items-start z-30">
          <span className="text-xl md:text-3xl font-bold font-brand-heading text-[#b3b4b6] leading-none whitespace-pre-line">{get('about.section_1_5_label_plant', 'Dragon\nFruit Plant')}</span>
        </div>
        <div className="absolute right-6 md:right-[10%] top-[30%] bottom-[20%] flex flex-col justify-between items-start z-30">
          <span className="text-xl md:text-3xl font-bold font-brand-heading text-[#b3b4b6] leading-none text-left whitespace-pre-line">{get('about.section_1_5_label_crush', 'Dragon\nFruit Crush')}</span>
          <span className="text-xl md:text-3xl font-bold font-brand-heading text-[#b3b4b6] leading-none text-left whitespace-pre-line">{get('about.section_1_5_label_fruit', 'Dragon\nFruit Fruit')}</span>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-32 gap-x-12 lg:gap-x-20 place-items-center">
            ...
            <div className="relative flex items-center justify-end w-full max-w-[500px] h-[100px] group cursor-pointer mt-12 md:mt-0">
              <div className="w-[80%] h-[75px] border border-[#c1c1c1] rounded-2xl flex items-center pl-24 lg:pl-28 pr-6 bg-transparent transition-colors duration-300 group-hover:bg-white/40">
                ...
                <span className="text-[#7a7a7a] font-light text-xl lg:text-[22px] tracking-wide">{get('about.grid_item_1_label', 'Dragon Fruit Crush')}</span>
              </div>
            ...
            <div className="relative flex items-center justify-end w-full max-w-[500px] h-[100px] group cursor-pointer mt-12 md:mt-0">
              <div className="w-[80%] h-[75px] border border-[#c1c1c1] rounded-2xl flex items-center pl-24 lg:pl-28 pr-6 bg-transparent transition-colors duration-300 group-hover:bg-white/40">
                <span className="text-[#888888] font-light text-2xl mr-4">+</span>
                <span className="text-[#7a7a7a] font-light text-xl lg:text-[22px] tracking-wide">{get('about.grid_item_2_label', 'Dragon Fruit Jam')}</span>
              </div>
            ...
            <div className="relative flex items-center justify-end w-full max-w-[500px] h-[100px] group cursor-pointer mt-12 md:mt-0">
              <div className="w-[80%] h-[75px] border border-[#c1c1c1] rounded-2xl flex items-center pl-24 lg:pl-28 pr-6 bg-transparent transition-colors duration-300 group-hover:bg-white/40">
                <span className="text-[#888888] font-light text-2xl mr-4">+</span>
                <span className="text-[#7a7a7a] font-light text-xl lg:text-[22px] tracking-wide">{get('about.grid_item_3_label', 'Dragon Fruit Fruit')}</span>
              </div>
            ...
            <div className="relative flex items-center justify-end w-full max-w-[500px] h-[100px] group cursor-pointer mt-12 md:mt-0">
              <div className="w-[80%] h-[75px] border border-[#c1c1c1] rounded-2xl flex items-center pl-24 lg:pl-28 pr-6 bg-transparent transition-colors duration-300 group-hover:bg-white/40">
                <span className="text-[#888888] font-light text-2xl mr-4">+</span>
                <span className="text-[#7a7a7a] font-light text-xl lg:text-[22px] tracking-wide">{get('about.grid_item_4_label', 'Dragon Fruit Plant')}</span>
              </div>
          ...
          <div className="relative z-10 flex flex-col lg:flex-row gap-10 lg:gap-6">
            ...
            <div className="w-full lg:w-[48%] flex flex-col relative min-h-[500px]">
              ...
              <div className="grid grid-cols-3 gap-3 mb-3">
                <div className="relative aspect-[4/3] rounded-3xl overflow-hidden shadow-lg border border-white/10 group">
                  <Image src={get('about.farm_small_1', '/images/about/farm_small_1.png')} alt="Farm Detail 1" fill className="object-cover transition-transform duration-700 group-hover:scale-110" />
                </div>
                <div className="relative aspect-[4/3] rounded-3xl overflow-hidden shadow-lg border border-white/10 group">
                  <Image src={get('about.farm_small_2', '/images/about/farm_small_2.png')} alt="Farm Detail 2" fill className="object-cover transition-transform duration-700 group-hover:scale-110" />
                </div>
                <div className="relative aspect-[4/3] rounded-3xl overflow-hidden shadow-lg border border-white/10 group">
                  <Image src={get('about.farm_small_3', '/images/about/farm_small_3.png')} alt="Farm Detail 3" fill className="object-cover transition-transform duration-700 group-hover:scale-110" />
                </div>
              </div>
              ...
              <div className="relative mb-6">
                ...
                <div className="flex items-center gap-6 lg:gap-10">
                  ...
                  <div className="ml-auto w-[225px] md:w-[300px] lg:w-[375px] h-[100px] md:h-[150px] lg:h-[188px] relative rounded-3xl overflow-hidden shadow-xl border-2 border-white/20 transition-transform duration-500 hover:scale-[1.02]">
                    <Image 
                      src={get('about.farm_split_image', '/images/about/farm_rows.png')} 
            ...
            <div className="w-full lg:w-[52%] flex flex-col relative min-h-[700px]">
              ...
              <div className="relative border-2 border-dashed border-[#c0c1c3] border-r-0 rounded-3xl pt-14 pb-14 pl-14 pr-0 mt-0 w-[calc(60%-100px)] z-10 overflow-visible bg-[#f1f1f2]">
                <h3 className="text-[3.51rem] md:text-[4.45rem] leading-[1.1] font-bold tracking-tight text-[#7a7b7d] font-avant-garde text-left whitespace-pre-line translate-x-[50px]">
              ...
              <div className="relative w-full mt-auto mb-[50px] flex items-center">
                ...
                <div className="bg-[#f1f1f2] rounded-2xl px-8 py-0 relative z-[10] flex items-center" style={{ marginLeft: '-80px' }}>
                  <h4 className="text-[2rem] md:text-[2.6rem] font-bold text-[#7a7b7d] leading-[1.1] tracking-tight font-avant-garde text-left whitespace-pre-line">
